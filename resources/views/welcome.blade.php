...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0"
        ...
        <!--TODO: ENLACES PARA REALIZAR DICHA ACCIONES-->
        <div
            style="display: grid;
                    align-items: center;
                    justify-content: center;
            ...
            <div style="text-align: center">
                ...
                <form action="/project/store" method="post">
                    @csrf
                    <input type="text" name="name" value="Nombre Proyecto 1">
                    <input type="text" name="description" value="Descripción Proyecto 1">
            ...
            <div style="text-align: center">
                ...
                <form action="/activity/store" method="post">
                    @csrf
                    <input type="text" name="name" value="Nombre Actividad 1">
                    <input type="text" name="description" value="Descripción Actividad 1">
            ...
            <div style="text-align: center">
                ...
                <form action="/incident/store" method="post">
                    @csrf
                    <input type="text" name="name" value="Nombre Incidencia 1">
                    <input type="text" name="description" value="Descripción Incidencia 1">
